...
[Download the app](https://github.com/Reebz/availability-click/releases/download/v1.2.1/availability-click_v1.2.1.dmg), or install with Homebrew: `brew install --cask Reebz/availability-click/availability-click`.
...
[Download the latest release](https://github.com/Reebz/availability-click/releases/download/v1.2.1/availability-click_v1.2.1.dmg), open it, and drag Availability Click to your Applications folder. Grant calendar access on first launch.
